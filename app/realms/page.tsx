...
export default function RealmsPage() {
  ...
  // If user has access to only 1 realm, skip this page entirely.
  useEffect(() => {
    if (loading) return;
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          ...
          >
            ...
            <div className="absolute inset-0 opacity-30 group-hover:opacity-60 transition-opacity" style={{ background: 'radial-gradient(circle at 30% 20%, rgba(155, 109, 255, 0.6), transparent 60%)' }} />
            ...
            <div className="relative">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-neon-violet to-neon-pink flex items-center justify-center mb-6 group-hover:scale-110 transition-transform shadow-lg">
              ...
              <div className="flex items-center gap-2 text-sm text-white/60">
                ...
                <FontAwesomeIcon icon={UI.arrowRight} className="ml-auto text-neon-pink group-hover:translate-x-1 transition-transform" />
              </div>
            </div>
          </button>
          ...
          >
            ...
            <div className="absolute inset-0 opacity-10 group-hover:opacity-20 transition-opacity" style={{ background: 'radial-gradient(circle at 70% 30%, rgba(16, 185, 129, 0.4), transparent 60%)' }} />
            <div className="absolute inset-0 rounded-3xl border border-slate-400/20 group-hover:border-emerald-400/40 transition-colors" />

            <div className="relative">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-slate-500 to-emerald-500 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
              ...
              <div className="flex items-center gap-2 text-sm text-slate-300/60">
                ...
                <FontAwesomeIcon icon={UI.arrowRight} className="ml-auto text-emerald-400 group-hover:translate-x-1 transition-transform" />
              </div>
            </div>
          </button>
        </div>
