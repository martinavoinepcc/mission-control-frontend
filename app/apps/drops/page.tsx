...
// On utilise un query param plutot qu'une route dynamique [slug] parce que le frontend
// est en `output: 'export'` (Render Static Site) qui ne supporte pas les segments
// dynamiques sans generateStaticParams() au build-time. Les drops etant crees au
// runtime par FRIDAY, on ne peut pas les enumerer avant.
